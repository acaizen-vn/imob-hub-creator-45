...
export const initializeDefaultData = () => {
  ...
  if (!settings) {
    const defaultSettings: Settings = {
      siteName: 'Conquista Imob',
      siteDescription: 'Encontre o imóvel dos seus sonhos com a Conquista Imob. Casas, apartamentos e terrenos nas melhores localizações de Barra Mansa e Volta Redonda.',
      logo: '/logo.png',
      whatsappNumber: '(24) 99875-3750',
      ...
      socialMedia: {
        instagram: 'https://instagram.com/conquistaimob',
        facebook: 'https://facebook.com/conquistaimob',
...
export const settingsService = {
  get: (): Settings => {
    const settings = localStorage.getItem('conquista-settings');
    if (settings) {
    ...
    localStorage.setItem('conquista-settings', JSON.stringify(defaultSettings));
